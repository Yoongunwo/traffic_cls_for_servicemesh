...
model = StudentEncoder_1x16()
model.load_state_dict(torch.load('./Model/student_encoder_kd_k8s_20_1x16.pth', map_location=torch.device('cpu')))
model.eval()

example_input = torch.randn(1, 1, 1479, 5)
traced = torch.jit.trace(model, example_input)
traced.save('./Model/student_encoder_1x16_ts.pt')
