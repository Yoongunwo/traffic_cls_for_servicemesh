...
model.load_state_dict(torch.load('./AI_Real/CAE/Model/cae_model_v2_20.pth', map_location=DEVICE))
...
fls = 2 * (precisions * recalls) / (precisions + recalls + 1e-8)
best_idx = np.argmax(fls)
