...
def main():
    ...
    # model.load_state_dict(torch.load(f'./AI_Real/CNN_OCSVM/Model/cnn_contrastive_encoder_k8s_{TEMPERATURE}_10.pth'))
    # model.eval()
    
    model = DeepEncoderv2().to(DEVICE)
    model.load_state_dict(torch.load(f'./AI_Real/CNN_OCSVM/Model/cnn_deep_contrastive_encoder_k8s_{TEMPERATURE}_{EPOCHS}_v2.pth'))
    model.eval()
    ...
    benign_test = benign_test[-1214:]  # Limit to 1214 for evaluation
